...
const Login = () => {
    ...
    return (
        <div className="login-page" style={{ textAlign: 'center' }}>
            ...
            <button  onClick={fbSignIn}  type="button" className="btn rounded-pill btn-block">
            <img src={fbIcon} alt="" width="30px" className="mb-1 mr-2" /> Continue With Facebook
          </button>
          <button  onClick={googleSignIn} type="button" className="btn rounded-pill btn-block">
            <img src={googleIcon} alt="" width="30px" className="mb-1 mr-2" /> Continue With Google
          </button>
